...
namespace KharlBanking
{
	public static class Helpers
	{
		...
		public static ApplicationUser GetCurrentUser(ApplicationDbContext _db, System.Security.Claims.ClaimsPrincipal User)
		{
			var user = _db.Users.Find(User.Claims.Where(p => p.Type == "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier").FirstOrDefault().Value);
